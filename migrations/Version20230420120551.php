 ...
 */
final class Version20230420120551 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, email, roles, password, lastname, firstname, address, phone FROM user');
        ...
        , password VARCHAR(255) NOT NULL COLLATE BINARY, lastname VARCHAR(255) DEFAULT NULL, firstname VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, email, roles, password, lastname, firstname, address, phone) SELECT id, email, roles, password, lastname, firstname, address, phone FROM __temp__user');
    ...
    public function down(Schema $schema): void
    {
        ...
        , password VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL COLLATE BINARY, firstname VARCHAR(255) NOT NULL COLLATE BINARY, address VARCHAR(255) NOT NULL COLLATE BINARY, phone VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO user (id, email, roles, password, lastname, firstname, address, phone) SELECT id, email, roles, password, lastname, firstname, address, phone FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
    }
