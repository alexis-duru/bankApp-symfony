 ...
 */
final class Version20230420155424 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__trading AS SELECT id, source_account_id, destination_account_id, amount, transaction_date, description FROM trading');
        $this->addSql('DROP TABLE trading');
        $this->addSql('CREATE TABLE trading (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, source_account_id INTEGER DEFAULT NULL, destination_account_id INTEGER DEFAULT NULL, amount DOUBLE PRECISION NOT NULL, transaction_date DATETIME NOT NULL, description VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_BC19FB58E7DF2E9E FOREIGN KEY (source_account_id) REFERENCES account (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_BC19FB58C652C408 FOREIGN KEY (destination_account_id) REFERENCES account (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO trading (id, source_account_id, destination_account_id, amount, transaction_date, description) SELECT id, source_account_id, destination_account_id, amount, transaction_date, description FROM __temp__trading');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__trading AS SELECT id, source_account_id, destination_account_id, amount, transaction_date, description FROM trading');
        $this->addSql('DROP TABLE trading');
        $this->addSql('CREATE TABLE trading (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, source_account_id INTEGER DEFAULT NULL, destination_account_id INTEGER DEFAULT NULL, amount DOUBLE PRECISION NOT NULL, transaction_date DATETIME NOT NULL, description VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO trading (id, source_account_id, destination_account_id, amount, transaction_date, description) SELECT id, source_account_id, destination_account_id, amount, transaction_date, description FROM __temp__trading');
        $this->addSql('DROP TABLE __temp__trading');
        $this->addSql('CREATE INDEX IDX_BC19FB58E7DF2E9E ON trading (source_account_id)');
        $this->addSql('CREATE INDEX IDX_BC19FB58C652C408 ON trading (destination_account_id)');
