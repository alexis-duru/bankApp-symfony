...
/**
 * @extends ServiceEntityRepository<Trading>
 *
...
class TradingRepository extends ServiceEntityRepository
{
    ...
    public function add(Trading $entity, bool $flush = false): void
    {
    ...
    public function remove(Trading $entity, bool $flush = false): void
    {
...
//    /**
//     * @return Trading[] Returns an array of Trading objects
//     */
...
//    public function findOneBySomeField($value): ?Trading
//    {
//        return $this->createQueryBuilder('t')
//            ->andWhere('t.exampleField = :val')
//            ->setParameter('val', $value)
